<template>
  <div class="student-card common-list-contain">
    <div class="student-base">
      <div class="student-header common-list-contain" @click="handleStudentInfo">
        <div class="SH-l">
          ...
          <div class="SH-tags">
            ...
            <div class="SH-tag" v-if="studentData.targetOne && studentData.targetOne.followUp">待跟进</div>
      ...
      <div class="student-info common-list-contain" style="padding-top: 0;" @click="handleStudentInfo">
        ...
        <div class="student-info-item" v-if="listType != 9">
          <div class="info-item">
            ...
            <span>
              ...
              <span v-if="listType === 'yuYueZiXun'">{{studentData.isFresh == 1 ? '在校生；' : studentData.isFresh == -1 || studentData.isFresh === '未知' ? '未知' : '社会考生'}}</span>
        ...
        <div class="student-info-item" v-if="!isDetail && listType === '7'">
          <div class="info-item">
            ...
            <span class="blue-title-color">投放信息：<span>{{studentData.seaPutTime}} {{studentData.seaPutUser}}</span></span>
          </div>
        </div>
        <!-- 预约咨询 - 咨询结果 学员档案不看 -->
        ...
        <!-- 6 下次回访 学员档案不看 -->
        <div class="student-info-item" v-if="!isDetail && listType != 9">
          <div class="info-item">
        ...
        <div class="student-more" v-if="isRotate">
          ...
          <!-- 8 来源渠道 -->
          <div class="student-info-item" v-if="studentData.sourceName">
            <div class="info-item">
          ...
          <!-- 9 所在城市 -->
          <div class="student-info-item" v-if="studentData.cityName">
            <div class="info-item">
          ...
          <div class="student-info-item">
            <div class="info-item">
              <span>
                ...
                <span>{{studentData.shellNameWap}}</span>
              </span>
            </div>
            <div class="info-item">
              <span>
      ...
      <div v-if="!isCloseBtn">
        ...
        <div class="student-btns" v-if="listType === '1' || listType === '9'">
          <van-button class="student-btn-item" v-permission="'PG:STU:RECORD_ADD'" @click="handleConsulRecord">
            <img src="@/assets/images/icons/btn_record.png" alt="">
            <span>添加咨询记录</span>
          </van-button>
          <van-button class="student-btn-item" v-permission="'PG:STU:FILE_EDIT'" @click="handleEditStudentInfo">
        ...
        <div class="student-btns" v-else-if="listType === '4' || listType === '9'">
          <van-button class="student-btn-item" v-permission="'PG:NOCOUNSEL:RECORD_ADD'" @click="handleConsulRecord">
            <img src="@/assets/images/icons/btn_record.png" alt="">
            <span>添加咨询记录</span>
          </van-button>
          <van-button class="student-btn-item" v-permission="'PG:NOCOUNSEL:CONSULT'" @click="handlePopSelect({ text: '预约咨询', dialogName: 'isConsultSubscribeShow' })">
            <img src="@/assets/images/icons/yuyue.png" alt="">
            <span>预约咨询</span>
          </van-button>
          <van-button class="student-btn-item" v-permission="'PG:NOCOUNSEL:EDIT'" @click="handleEditStudentInfo">
            <img src="@/assets/images/icons/btn_edit.png" alt="">
            <span>编辑</span>
          </van-button>
          <van-button class="student-btn-item" v-if="actions.length">
        ...
        <div class="student-btns" v-else-if="listType === '5'">
          <van-button class="student-btn-item" v-permission="'PG:WAITSTU:BATCH_DISTRIBUTION_COUNSELOR'" @click="handlePopSelect({ text: '分配咨询', dialogName: 'isConsultDistributeShow' })">
            <img src="@/assets/images/icons/ConsultSubscribe.png" alt="">
            <span>分配咨询</span>
          </van-button>
          <van-button class="student-btn-item" v-permission="'PG:WAITSTU:CONSULT'" @click="handlePopSelect({ text: '预约咨询', dialogName: 'isConsultSubscribeShow' })">
            <img src="@/assets/images/icons/yuyue.png" alt="">
            <span>预约咨询</span>
          </van-button>
          <van-button class="student-btn-item" v-if="actions.length">
        ...
        <div class="student-btns" v-else-if="listType === '7'">
          <van-button class="student-btn-item" v-permission="'PG:HS:GET'" @click="handleGetSea">
            <img src="@/assets/images/icons/getConsultSea.png" alt="">
            <span>领取</span>
          </van-button>
          <van-button class="student-btn-item" v-permission="'PG:HS:BATCH_DISTRIBUTION_COUNSELOR'" @click="handlePopSelect({ text: '分配咨询', dialogName: 'isConsultDistributeShow' })">
            <img src="@/assets/images/icons/ConsultSubscribe.png" alt="">
            <span>分配咨询</span>
          </van-button>
        </div>
        ...
        <div class="student-btns" v-else-if="listType === '8'">
          <van-button class="student-btn-item" v-permission="'PG:WAIT:RECORD_ADD'" @click="handleConsulRecord">
            <img src="@/assets/images/icons/btn_record.png" alt="">
            <span>添加咨询记录</span>
          </van-button>
          <van-button class="student-btn-item" v-permission="'PG:WAIT:RECORD_EDIT'" @click="handleEditStudentInfo">
            <img src="@/assets/images/icons/btn_edit.png" alt="">
            <span>编辑</span>
          </van-button>
        ...
        <div class="student-btns" v-else-if="listType === 'yuYueZiXun'">
          <van-button class="student-btn-item" v-permission="'PG:RC:ADD_RECORD'" @click="handleConsulRecord">
            <img src="@/assets/images/icons/btn_record.png" alt="">
            <span>添加咨询记录</span>
          </van-button>
          <van-button class="student-btn-item" v-permission="'PG:RC:CR'" :disabled="!studentData.consultantName" @click="handleAddConsulResult">
            <img src="@/assets/images/icons/addOrder.png" alt="">
            <span>咨询结果</span>
          </van-button>
          <van-button class="student-btn-item" v-permission="'PG:RC:EDIT_STU'" @click="handleEditStudentInfo">
            <img src="@/assets/images/icons/btn_edit.png" alt="">
            <span>编辑</span>
          </van-button>
          <van-button class="student-btn-item" v-permission="'PG:RC:EDIT_CONSULT'" :disabled="!studentData.appointmentTimeState" @click="handlePopSelect({ text: '预约咨询', dialogName: 'isConsultSubscribeShow' })">
            <img src="@/assets/images/icons/btn_edit.png" alt="">
            <span>修改预约</span>
          </van-button>
        </div>
    ...
    <ConsultSubscribe :is-open.sync="isConsultSubscribeShow" :sId="sId" @complete="handleUpdataInfo" :reserveConsultId="reserveConsultId" :counselState="studentData.state" @delcomplete="handleDelComplete" />
    <!-- 分配咨询师 -->
    ...
    <!-- 移交 -->
    <ConsultHandOver :is-open.sync="isConsultHandOverShow" :sId="sId" @complete="handleUpdataInfo" />
    <!-- 转交 -->
  ...
  computed: {
    ...
    actions() {
      ...
      if (this.listType === '1' || this.listType === '9') {
        return [
          { text: this.studentData.reserveConsultId ? '修改预约' : '预约咨询', dialogName: 'isConsultSubscribeShow', permission_btn: 'PG:STU:CONSULT' },
          { text: '分配咨询', dialogName: 'isConsultDistributeShow', permission_btn: 'PG:STU:BATCH_DISTRIBUTION' },
          { text: '修改市场区域', dialogName: 'isConsultMarketAreaShow', permission_btn: 'PG:STU:MARKET_AREA' },
          { text: '移交', dialogName: 'isConsultHandOverShow', permission_btn: 'PG:STU:HAND_OVER' },
          { text: '转交', dialogName: 'isConsultDeliverShow', permission_btn: 'PG:STU:DELIVER' },
          { text: '放入公海', dialogName: 'isConsultSeaShow', permission_btn: 'PG:STU:PUT_PUBLIC' },
          { text: '新增订单', dialogName: '', permission_btn: 'PG:STU:ADD_ORDER' }
        ]
      } else if (this.listType === '4') {
        arr = [
          { text: '分配咨询', dialogName: 'isConsultDistributeShow', permission_btn: 'PG:NOCOUNSEL:BATCH_DISTRIBUTION' },
          { text: '修改市场区域', dialogName: 'isConsultMarketAreaShow', permission_btn: 'PG:NOCOUNSEL:MARKET_AREA' },
          { text: '移交', dialogName: 'isConsultHandOverShow', permission_btn: 'PG:NOCOUNSEL:HAND_OVER' },
          { text: '转交', dialogName: 'isConsultDeliverShow', permission_btn: 'PG:NOCOUNSEL:DELIVER' },
          { text: '放入公海', dialogName: 'isConsultSeaShow', permission_btn: 'PG:NOCOUNSEL:PUT_PUBLIC' },
          { text: '新增订单', dialogName: '', permission_btn: 'PG:NOCOUNSEL:ADD_ORDER' }
        ]
      } else if (this.listType === '5') {
        arr = [
          { text: '编辑', dialogName: 'editStudent', permission_btn: 'PG:WAITSTU:EDIT' },
          { text: '添加咨询记录', dialogName: 'addCounselRecord', permission_btn: 'PG:WAITSTU:RECORD_ADD' },
          { text: '移交', dialogName: 'isConsultHandOverShow', permission_btn: 'PG:WAITSTU:HAND_OVER' },
          { text: '放入公海', dialogName: 'isConsultSeaShow', permission_btn: 'PG:WAITSTU:PUT_PUBLIC' },
          { text: '新增订单', dialogName: '', permission_btn: 'PG:WAITSTU:ADD_ORDER' }
        ]
      }
